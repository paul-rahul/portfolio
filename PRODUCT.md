...
Recruiters skim; the Career page is the page under real time pressure. Other pages (About, Built, Contact) are visited by someone already convinced enough to look deeper, so they can carry more voice and personality.
...
- Resume: no dedicated page — a direct PDF download link (`/Rahul_Paul_Resume.pdf`) remains on the homepage hero. General (not company-targeted).
...
- **Career**: credential-forward, metric-first. Numbers stated directly, attributed to scope, never softened. A rare human aside is fine if it earns its place; it is not the house style here.
...
1. Scannable credibility over narrative charm on Career — a recruiter's few seconds of attention drives structure, not storytelling.
