...
| IMG-04 | About | Intro (live) | Rahul portrait/candid | 4:5 | Needed |
| IMG-05 | About | McCombs card (live) | Campus or MBA-context photo | 4:3 | Needed |
| IMG-06 | About | Off the clock card (live) | Badminton/action photo | 4:3 | Needed |
| ~~IMG-07~~ | About | ~~Personal / candid~~ | Folded into IMG-04 | — | Dropped — Stage 6 found no distinct third content block to attach a separate candid slot to without inventing new personal copy; IMG-04's portrait already covers "professional portrait or candid" as one flexible slot per its description. |
